...
#+BEGIN_SRC haskell
myFont :: String
myFont = "xft:Monofur:regular:size=12:antialias=true:hinting=true"

myModMask :: KeyMask
myModMask = mod4Mask        -- Sets modkey; mod4Mask = Super
...
myStartupHook = do
    ...
    spawnOnce "xsetroot -cursor_name left_ptr" -- fixes mouse
    setWMName "xmonad"
#+END_SRC
...
myShowWNameTheme = def
    { swn_font              = "xft:Monofur:bold:size=58"
    , swn_fade              = 1.0
    , swn_bgcolor           = "#1c1f24"
    , swn_color             = "#ffffff"
    }
...
myKeys =
    -- KB_GROUP Xmonad
	    ...
	    , ("M-<Escape>", spawn "i3lock -c 282C34")                -- Locks screen
    -- KB_GROUP Dmenu
        , ("M-<Return>", spawn "dmenu_run -p 'Execute:'") -- Dmenu
	, ("M-C-v", spawn "clipmenu") -- Clipmenu
    ...
    -- launch dmenu_run, so I've decided to use M-p plus KEY for these dmenu scripts.
        ...
        , ("M-s c", spawn "alacritty -e $HOME/.scripts/dmenu/dm-configs")  -- edit config files
        , ("M-s p", spawn "$HOME/.scripts/dmenu/dm-portage") -- run portage actions
	, ("M-s k", spawn "$HOME/.scripts/dmenu/dm-power") -- system logout
    ...
    -- KB_GROUP Floating windows
        ...
        , ("M-C-S-t", sinkAll)                       -- Push ALL floating windows to tile

    -- KB_GROUP Increase/decrease spacing (gaps)
        --, ("C-M1-d", decWindowSpacing 4)         -- Decrease window spacing
        --, ("C-M1-h", incWindowSpacing 4)         -- Increase window spacing
        --, ("C-M1-t", decScreenSpacing 4)         -- Decrease screen spacing
	...
	, ("M-C-S-m", windows W.swapMaster) -- Swap the focused window and the master window
