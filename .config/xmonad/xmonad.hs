...
myBrowser :: String
myBrowser = "brave-bin"		-- Sets default browser

myEmacs :: String
myEmacs = "emacsclient -c -a 'emacs' "  -- Makes emacs keybindings easier to type

myFileManager :: String
myFileManager = "dolphin"	-- Sets default file manager
...
myStartupHook = do
  ...
  spawnOnce "xrandr --output DisplayPort-1 --mode 3440x1440 --rate 144 --pos 0x1440 --output DisplayPort-2 --mode 3440x1440 --rate 144 --pos 0x0 &" -- Xrandr (Display 2 over 1)
...
myKeys c =
  ...
  , ("M1-<Space>",	addName "Run prompt"       	$ spawn "rofi -show run -font 'mononoki 12'")
  ...
  , ("M1-g m",          addName "Launch Prism"          $ spawn "prismlauncher")
  ...
  , ("M1-w k",		addName "Launch Kate"		$ spawn "kate")
  ...
  ^++^ subKeys "Sublayouts" -- This is used to push windows to tabbed sublayouts, or pull them out of it.
